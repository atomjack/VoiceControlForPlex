...
public class OldMainActivity extends VCFPActivity implements TextToSpeech.OnInitListener {
	...
	public void emailDeviceLogs(final String wearLog) {
		new AsyncTask<Void, Void, Void>() {
			...
			protected Void doInBackground(Void... params) {
				try {
          boolean hasPermission = (ContextCompat.checkSelfPermission(OldMainActivity.this,
  ...
  public void showChangelog(MenuItem item) {
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Collections.sort(availableVoices);
			...
			AlertDialog.Builder usageDialog = new AlertDialog.Builder(OldMainActivity.this);
    ...
    if(currentNetworkState == NetworkState.MOBILE)
      clientName = getString(R.string.this_device);
		...
		settingsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
          ...
          searchDialog.show();
          Intent scannerIntent = new Intent(OldMainActivity.this, PlexScannerService.class);
    ...
    */
	...
	public void settingRowHelpButtonClicked(View v) {
		...
		if(helpDialog == null) {
			helpDialog = new AlertDialog.Builder(OldMainActivity.this);
		}
	...
	private void selectFeedback(final boolean errors) {
		...
		final OldMainActivity ctx = this;
	...
	public void showAbout(MenuItem item) {
		AlertDialog.Builder alertDialog = new AlertDialog.Builder(OldMainActivity.this)
...
//		menu.findItem(R.id.menu_logout).setVisible(!menu.findItem(R.id.menu_logout).isVisible());
	...
	private void showPin(final Pin pin) {
		AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(OldMainActivity.this);
	...
	private void showManualLogin() {
		LayoutInflater layoutInflater = LayoutInflater.from(OldMainActivity.this);
  ...
  public void showWearOptions(MenuItem item) {
    ...
    chooserDialog.setPositiveButton(R.string.voice_input, new DialogInterface.OnClickListener() {
      public void onClick(DialogInterface dialog, int id) {
        ...
        new SendToDataLayerThread(WearConstants.SET_WEAR_OPTIONS, dataMap, OldMainActivity.this).start();
        dialog.dismiss();
      }
    });
