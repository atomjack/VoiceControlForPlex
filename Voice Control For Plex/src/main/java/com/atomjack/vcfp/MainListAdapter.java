...
public class MainListAdapter extends ArrayAdapter<MainSetting> {
	...
	static class SettingHolder {
		...
		final static String TAG_SERVER = "server";
		final static String TAG_CLIENT = "client";
		final static String TAG_FEEDBACK = "feedback";
		final static String TAG_ERRORS = "errors";
